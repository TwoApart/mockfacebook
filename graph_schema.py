...
{'connections': {u'album': [u'photos', u'likes', u'comments'],
                 ...
                 u'page': [u'feed',
                           ...
                           u'events',
                           u'statuses'],
                 u'photo': [u'likes', u'comments', u'tags'],
                 u'status': [u'likes', u'comments', u'tags'],
                 u'user': [u'feed',
                           u'tagged',
                           u'family',
                           u'picture',
 ...
 'tables': {u'album': [Column(name=u'id', fb_type='string', sqlite_type='TEXT', indexable=None),
            ...
            u'user': [Column(name=u'id', fb_type='string', sqlite_type='TEXT', indexable=None),
                      ...
                      Column(name=u'cover', fb_type='string', sqlite_type='TEXT', indexable=None),
